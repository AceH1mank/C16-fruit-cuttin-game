...
function draw() {
  ...
  if(gameState===PLAY){
    ...
    if(fruitGroup.isTouching(knife)){
      ...
      if(score/10 == 0){
        monsterGroup.velocityX=monsterGroup.velocityX-3;
      }*/

     
     //fruitGroup.velocityX=-(2+(score/2));
...
function Monster(){
  if(World.frameCount%200===0){
    ...
    monster.velocityX=-(3+(score/2));
    console.log("monser :"+monster.velocityX);
  }
}
  ...
  if(World.frameCount%80===0){
    ...
    else
    {
     ...
     //update below give line of code for increase fruitGroup speed by 4
      ...
      console.log("Fruit :"+ fruit.velocityX);
